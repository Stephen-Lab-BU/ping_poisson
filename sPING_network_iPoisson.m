function sPING_network_iPoisson(sim_length,ErPoissonAMPA,EgPoissonAMPA,ErPoissonGABAA,EgPoissonGABAA,IrPoissonAMPA,IgPoissonAMPA,IrPoissonGABAA,IgPoissonGABAA,varargin)
...
s.populations(1).parameters={'Iapp',0,'gNa',120,'gK',36,'noise',40,'DCAMPA',ErPoissonAMPA,'gextAMPA',EgPoissonAMPA,'EextAMPA',0,'DCGABAA',ErPoissonGABAA,'gextGABAA',EgPoissonGABAA,'EextGABAA',-80};
s.populations(2).name='I';
s.populations(2).size=20;
s.populations(2).equations=eqns;
s.populations(2).mechanism_list={'iNa','iK','iPoissonAMPA','iPoissonGABAA'};
s.populations(2).parameters={'Iapp',0,'gNa',120,'gK',36,'noise',40,'DCAMPA',IrPoissonAMPA,'gextAMPA',IgPoissonAMPA,'EextAMPA',0,'DCGABAA',IrPoissonGABAA,'gextGABAA',IgPoissonGABAA,'EextGABAA',-80};
...
data=dsSimulate(s,'tspan',[0 sim_length], 'study_dir','demo_sPING_0',varargin{:});
